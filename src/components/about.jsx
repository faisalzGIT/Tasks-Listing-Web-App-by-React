    ...
    <>
        <div className="bg-purple-100 min-h-[92vh] flex justify-center items-center w-full">
            <div className="bg-white rounded-xl shadow-lg p-10 pt-7 pb-3 w-[1200px] max-w-full text-center">
                 <h1 className="mb-0 flex justify-center gap-4 text-4xl font-bold text-center text-purple-900">
                    <span className="monoton-regular text-5xl font-bold mb-4 text-purple-900 tracking-wider">How</span>
                    <span className="monoton-regular text-5xl font-bold mb-4 text-purple-900 tracking-wider">This</span>
                    <span className="monoton-regular text-5xl font-bold mb-4 text-purple-900 tracking-wider">Website</span>
                    <span className="monoton-regular text-5xl font-bold mb-4 text-purple-900 tracking-wider">Was</span>
                    <span className="monoton-regular text-5xl font-bold mb-4 text-purple-900 tracking-wider">Made</span>
                </h1>
                ...
                <div className="mb-4 px-4">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 text-purple-800">
                        ...
                        </div>                        <div className="bg-purple-100 rounded-xl p-5 shadow hover:shadow-md transition duration-300">                            <h3 className="font-bold text-lg mb-2">Layout & Styling</h3>
                            <p>

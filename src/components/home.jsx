            ...
            <div className="relative p-8 md:p-14 text-center z-10">
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-[4vh] mb-10">
                  <div className={`bg-purple-50 ${boool ? `h-15` : `h-33`} md:h-40 rounded-xl py-5 md:p-6  shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col gap-0 ${boool && 'flex-row'} items-center justify-center `}>

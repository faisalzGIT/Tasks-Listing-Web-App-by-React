        ...
        <div className={` w-[100vw] bg-white h-[92vh] shadow-xl overflow-x-hidden overflow-y-hidden  md:overflow-y-hidden `}>
          ...
          <div className="relative">
            ...
            <div className="relative p-8 md:p-14 text-center z-10">
               ...
               */}
              {/* Title with Gradient */}
              <h1 className={`text-2xl md:text-5xl w-fit m-auto font-extrabold mb-0 md:mb-2 ${boool ? 'tracking-normal': 'tracking-wider'}`}>
                <span className="monoton-regular flex justify-center gap-4 md:gap-5 bg-clip-text text-transparent bg-gradient-to-r from-purple-700 via-purple-800 to-purple-900">
                  <span>Welcome</span> 
                  <span>to</span>
                  <span>iTasks</span>
                </span>
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-[4vh] mb-10">
                  <div className={`bg-purple-50 ${boool ? `h-16` : `h-33`} md:h-40 rounded-xl py-5 md:p-6  shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col gap-0 ${boool && 'flex-col'} items-center justify-center `}>
                    <div className={`${boool ? 'hidden md:flex' : 'flex'} w-8 h-8 md:w-12 md:h-12 md:mx-auto  my-3 md:mb-4 bg-purple-200 rounded-full items-center justify-center`}>
                  ...
                  <div className={`bg-purple-50 ${boool ? `h-16` : `h-33`} md:h-40 rounded-xl py-5 md:p-6  shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col gap-0 ${boool && 'flex-col'} items-center justify-center `}>
                    ...
                    <p className="w-[45vw] md:w-[20vw] m-auto text-purple-800 text-nowrap font-medium text-[14px]">Stay organized</p>
                  </div>
                </div>
              </div>
